# Azul Plugin Entrypointcheck

Check for anomalies in the entrypoint section.

## Development Installation

To install azul-plugin-entrypointcheck for development run the command
...
```bash
$ azul-plugin-entrypointcheck malware.file
... example output goes here ...
```

Check `azul-plugin-entrypointcheck --help` for advanced usage.
