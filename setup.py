...
setup(
    name="azul-plugin-entrypointcheck",
    description="Check for anomalies in the entrypoint section.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_entrypointcheck"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-entrypointcheck = azul_plugin_entrypointcheck.main:main",
        ]
    },
